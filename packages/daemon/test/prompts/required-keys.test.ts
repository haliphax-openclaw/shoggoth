...
describe("REQUIRED_PROMPT_KEYS", () => {
  ...
  it("lists every .md file on disk", () => {
    ...
    assert.deepStrictEqual(
      missing,
      [],
      `Files on disk missing from REQUIRED_PROMPT_KEYS: ${missing.join(", ")}`,
    );
  });
  ...
  it("has no entries without a matching .md file", () => {
    ...
    assert.deepStrictEqual(
      extra,
      [],
      `REQUIRED_PROMPT_KEYS entries with no .md file: ${extra.join(", ")}`,
    );
  });
});
...
describe("REQUIRED_NOTICE_KEYS", () => {
  ...
  it("lists every .md file on disk", () => {
    ...
    assert.deepStrictEqual(
      missing,
      [],
      `Files on disk missing from REQUIRED_NOTICE_KEYS: ${missing.join(", ")}`,
    );
  });
  ...
  it("has no entries without a matching .md file", () => {
    ...
    assert.deepStrictEqual(
      extra,
      [],
      `REQUIRED_NOTICE_KEYS entries with no .md file: ${extra.join(", ")}`,
    );
  });
});
